      ...
      <div class="solutions__cards">
        <article class="scard">
          <div class="scard__media">
            <img data-media="solutions_risk" src="assets/riskmuh1.jpg" alt="Risk mühendisliği ve analizi" width="720" height="400" loading="lazy" />
        ...
        <article class="scard">
          <div class="scard__media">
            <img data-media="solutions_damage" src="assets/hatahasar1.jpg" alt="Hızlı hasar yönetimi" width="720" height="400" loading="lazy" />
